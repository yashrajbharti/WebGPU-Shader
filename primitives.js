 ...
 */
export function generateTriangleNormalsInPlace(data) {
 ...
 */
export function facet(vertexData) {
 ...
 */
export function reorientInPlace(vertexData, matrix) {
